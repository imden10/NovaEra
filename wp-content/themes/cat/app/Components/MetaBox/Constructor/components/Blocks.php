...
class Blocks
{
    public $name = 'Карточки в колонки';
    ...
    public function html($key, $name, $value)
    {
        ...
        $orientation = [
            ...
            'value' => (isset($value['content']['icon_type'])) ? $value['content']['icon_type'] : 'big'
        ];
        ...
        <div class="body-block">
            <div class="list-elements-body">
                ...
                <div class="mb-3">
                    <label for="items_in_row" class="form-label"><?php _e('Карточки в колонки'); ?></label>
                ...
                <div class="mb-3">
                    <label class="form-label"><?php _e('Орієнтація'); ?></label>
                    <select name="<?php echo $orientation['name']; ?>" class="form-control form-control-sm">
                        <?php foreach ($orientationList as $orientationListKey => $orientationListItem) : ?>
                            <option value="<?php echo $orientationListKey; ?>"<?php echo ($orientation['value'] == $orientationListKey) ? ' selected' : ''; ?>><?php echo $orientationListItem; ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
