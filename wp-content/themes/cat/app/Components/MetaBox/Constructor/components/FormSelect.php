...
class FormSelect
{
    ...
    public function html($key, $name, $value)
    {
        ...
        $optionsField = [
            ...
            'subtitle' => 'У кожному рядку по варіанту<br>Наприклад:<br>red:Червоний',
            'name'     => $name . '[' . $key . '][content][options]',
            'value'    => isset($value['content']['options']) ? $value['content']['options'] : ''
        ];
        ...
        <div class="body-block">
            <div style="width: 100%">
                ...
                <div style="display: flex;gap:15px;width: 100%;margin-bottom: 15px">
                    <div style="width: 30%;text-align: right">
                        <label><?= $optionsField['title'] ?></label>
                        <div style="color: #676565;font-size: 11px;">
                            <span><?= $optionsField['subtitle'] ?></span>
                        </div>
                    </div>
                    <div style="width: 70%">
                        <textarea name="<?= $optionsField['name'] ?>" class="form-control" cols="30" rows="10"><?= $optionsField['value']; ?></textarea>
                    </div>
                </div>
