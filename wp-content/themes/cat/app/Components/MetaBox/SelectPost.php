...
class SelectPost extends BaseMetaBox
{
    public function html()
    {
        if (!empty($this->params['list'])) : ?>
            ...
            <div class="form-group meta-box-form-group">
                ...
                <select id="<?php echo $this->name; ?>" class="form-control meta-box-post-select-field <?php echo $this->name; ?>-select2" name="<?php echo $this->name; ?>">
                    <option value="">---</option>
